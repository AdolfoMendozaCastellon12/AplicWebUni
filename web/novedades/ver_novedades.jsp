            ...
            <div class="porlets-content">
              <form action="" class="form-horizontal row-border">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="password" class="form-control" placeholder="0" disabled="">
                  </div>
                </div><!--/form-group--> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="" class="form-control" placeholder="0" disabled="">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="date" class="form-control" placeholder="0" disabled="">
                  </div>
                </div><!--/form-group--> 

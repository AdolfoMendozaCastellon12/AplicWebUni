          ...
          <div class="adv-table editable-table ">
                  ...
                  <span class=""><button class="btn btn-primary" type="submit" name="btnBuscar" value="buscar"><i class="fa fa-search"></i> Buscar</button></span>
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
                              ...
                              <tbody>
                                   <%
                      if(request.getAttribute("listNovedad")!=null){
                      List<Novedad> listNovedad = new ArrayList();
                      listNovedad = (List<Novedad>) request.getAttribute("listNovedad");
                      
                      
                      for(Novedad ndad : listNovedad){
                   %>
                              <tr class="">
                             ...
                             <input type="hidden" name="codigo" value='<%= ndad.getIdNoved()%>'/>
                                  ...
                                  <td class="center"><a class="edit" href="Config_novedades.jsp">Configurar</a></td>

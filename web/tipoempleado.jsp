        ...
        <div class="col-md-5">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">TIPO EMPLEADO</h3>
            </div>
            ...
            <div class="porlets-content">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="number" class="form-control"  name="codtipoempleado" value='<%= codigo %>' disabled="">
                      
                  </div>
                      <input type="hidden" class="form-control"  name="codtipoempleado" value='<%= codigo %>'>
                </div><!--/form-group--> 

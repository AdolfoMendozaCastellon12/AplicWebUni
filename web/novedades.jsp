          ...
          <div class="block-web">
            ...
            <div class="porlets-content">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="text" class="form-control" name="codnovedad" value="<%= codigo %>" disabled="">
                  </div>
                  <input type="hidden" class="form-control" name="codnovedad" value="<%= codigo %>">
                </div><!--/form-group--> 

                <div class="form-group">
                  <label class="col-sm-3 control-label">Numeros Matriculados Ordinarios</label>
                  <div class="col-sm-9">
                      <input type="number" class="form-control" placeholder="0" name="matriculadosordinarios">
                  </div>
                </div><!--/form-group--> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="number" class="form-control" placeholder="0" name="matriculadosextemporaneo">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="number" class="form-control" placeholder="0" name="retirosvoluntarios">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="number" class="form-control" placeholder="0" name="totalretiros">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="number" class="form-control" placeholder="0" name="cancelacionmes">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="number" class="form-control" placeholder="0" name="cancelacionficha">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="number" class="form-control" placeholder="0" name="aplazamientolectivo">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="number" class="form-control" placeholder="0" name="aprendicesregistrados">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="" class="form-control" placeholder="0" name="aprendicesformacion">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="date" class="form-control" placeholder="0" name="fecharegistro">
                  </div>
                </div><!--/form-group-->
               ...
               <input type="hidden" class="form-control" name="eliminado" value="1">
                <div class="bottom">

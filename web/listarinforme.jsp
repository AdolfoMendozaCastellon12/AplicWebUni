<%-- 
    Document   : listarinforme
    Created on : 15/08/2017, 06:37:24 PM
    Author     : FLIACHICA
--%>
        ...
        <div class="col-md-12">
         ...
         <div class="porlets-content">
          <div class="adv-table editable-table ">
                          <div class="clearfix">
                              <div class="btn-group">
                                  <button id="editable-sample_new" class="btn btn-primary" onclick="window.location.href='informe.jsp'">
                                      Nuevo Informe <i class="fa fa-plus"></i>
                                  </button>
                              </div>
                               <form class="">
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
                              ...
                              <tr class="">
                                  ...
                                  <td></td>
                                  <td></td>
                                  <td><a class="edit" href="ver_informe.jsp">Ver</a></td>
                                  <td><a class="delete" href="Config_informe.jsp">Configurar</a></td>

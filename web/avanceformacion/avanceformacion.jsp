        ...
        <div class="col-md-5">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">AVANCE DE FORMACION</h3>
            </div>
            <div class="porlets-content">
              <form action="avanceforsvl" method="post" class="form-horizontal row-border">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Codigo Avance Formacion</label>
                  <div class="col-sm-9">
                      <input type="number" class="form-control"  name="Codigo1">
                  </div>
                </div><!--/form-group--> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="number" class="form-control"  name="Codigo2">
                  </div>
                </div><!--/form-group--> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="number" class="form-control" placeholder="0" name="Codigo3">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="number" class="form-control" placeholder="0" name="Codigo4">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="number" class="form-control" placeholder="0" name="Codigo5">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <input type="number" class="form-control" placeholder="0" name="Codigo6">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="number" class="form-control" placeholder="0" name="Codigo7">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="number" class="form-control" placeholder="0" name="Codigo8">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="number" class="form-control" placeholder="0" name="Codigo9">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="0" name="Codigo10">
                  </div>
                </div><!--/form-group-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="number" class="form-control" placeholder="0" name="Codigo11">
                  </div>
                </div><!--/form-group--> 
                
                <div class="bottom">
                  <button type="submit" name="btnRegistrar" value="Registrar" class="btn btn-success btn-icon"> Aceptar<i class="fa fa-check-square"></i> </button>
